...
def _synthesize_chunk(text: str, voice_id: str, api_key: str, language: str = "en") -> bytes:
...
def synthesize_speech(text: str, voice_preference: int = 1, language: str = "en") -> str:
    api_key = os.environ.get("INWORLD_API_KEY")
    voice_id = os.environ.get("INWORLD_VOICE_ID")

    chunks = _chunk_text(text)
    audio_parts = [_synthesize_chunk(chunk, voice_id, api_key, language) for chunk in chunks]
